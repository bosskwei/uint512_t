...
class uint128_t : public base<uint128_t, uint64_t> {
   public:
    ...
    std::string toStringQuick() const override {
        return stringFormat("%016" PRIX64 "%016" PRIX64 "", this->hi_,
                            this->lo_);
    }
...
class uint256_t : public base<uint256_t, uint128_t> {
   public:
    uint256_t() : base(0, 0) {}
    uint256_t(uint64_t value) : base(0, value) {}
    uint256_t(const uint128_t &value) : base(0, value) {}
    uint256_t(const uint128_t &hi, const uint128_t &lo) : base(hi, lo) {}
    explicit uint256_t(const std::string &value) : base(0, 0) {
...
public:
    ...
    void asComplement() override {
        const uint256_t MAX_UINT256 = uint256_t(
            uint128_t(0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF),
            uint128_t(0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF)
        );
